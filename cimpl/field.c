 ...
 * 
 */
  __pyx_t_6 = (__pyx_v__data != Py_None);
...
static PyObject *__pyx_f_14sparsebitfield_14SparseBitfield_issuperset(struct __pyx_obj_14sparsebitfield_SparseBitfield *__pyx_v_self, struct __pyx_obj_14sparsebitfield_SparseBitfield *__pyx_v_other, int __pyx_skip_dispatch) {
  ...
  /* Check if overridden in Python */
    ...
    if (!PyCFunction_Check(__pyx_t_1) || (PyCFunction_GET_FUNCTION(__pyx_t_1) != (PyCFunction)__pyx_pw_14sparsebitfield_14SparseBitfield_56issuperset)) {
      ...
      if (!__pyx_t_4) {
        __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_3, ((PyObject *)__pyx_v_other)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 538, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
      } else {
        #if CYTHON_FAST_PYCALL
        if (PyFunction_Check(__pyx_t_3)) {
...
static PyMethodDef __pyx_methods_14sparsebitfield_SparseBitfield[] = {
  ...
  {"pickle", (PyCFunction)__pyx_pw_14sparsebitfield_14SparseBitfield_66pickle, METH_VARARGS|METH_KEYWORDS, __pyx_doc_14sparsebitfield_14SparseBitfield_65pickle},
...
static int __pyx_pymod_exec_sparsebitfield(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init sparsebitfield", 0, __pyx_lineno, __pyx_filename);
    }
